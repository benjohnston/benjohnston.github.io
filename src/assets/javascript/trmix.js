/* Type Rendering Mix JS - (c) 2013-2014 Tim Brown, Bram Stein. License: new BSD */
(function() { // Input 0
  var COMPILED = !0,
    goog = goog || {};
  goog.global = window;
  ...
  goog.provide = function $goog$provide$($name$$) {
    if (!COMPILED) {
      ...
      for (var $namespace$$ = $name$$;
        ($namespace$$ = $namespace$$.substring(0, $namespace$$.lastIndexOf("."))) && !goog.getObjectByName($namespace$$);) {
  ...
  goog.cloneObject = function $goog$cloneObject$($obj$$) {
    ...
    if ("object" == $clone_type$$ || "array" == $clone_type$$) {
      ...
      var $clone_type$$ = "array" == $clone_type$$ ? [] : {},
        $key$$;
      for ($key$$ in $obj$$) {
  ...
  tr.UserAgent.parse = function $tr$UserAgent$parse$($userAgent$$) {
    var $browser$$ = tr.Browser.UNKNOWN,
      $browserVersion$$ = new tr.Version,
      $platform$$ = tr.Platform.UNKNOWN,
      $platformVersion$$ = new tr.Version,
      $match$$ = null;
